 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "        \"First, analyze the task in <thinking> tags. Then, provide the solution in a single ```bash code block. \"\n",
    "        \"CRITICAL: The code block must contain ONLY executable bash commands. NO comments (#), NO explanations, NO placeholders. Just raw, efficient code.\"\n",
    "    )\n",
    "    \n",
