 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    # Curriculum\n",
    "    if iteration < 5:\n",
    "        filtered_tasks = [t for t in all_tasks if t.get(\"category\", \"\").lower() in [\"easy\", \"basic\", \"files\", \"text\", \"medium\", \"search\", \"script\", \"git\"]]\n",
    "    elif iteration < 15:\n",
    "        filtered_tasks = [t for t in all_tasks if t.get(\"category\", \"\").lower() in [\"easy\", \"basic\", \"files\", \"text\", \"medium\", \"search\", \"script\", \"git\", \"hard\"]]\n",
    "    else:\n",
